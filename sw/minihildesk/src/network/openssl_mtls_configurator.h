...
class OpenSslMtlsConfigurator : public IMtlsConfigurator {
public:
  OpenSslMtlsConfigurator() = default;
  ~OpenSslMtlsConfigurator() override = default;

  bool configureContext(void *ctx) override;
};
